...
struct Constants {
    ...
    static let prodServer = GoodNetworking.ApiServer(name: "CARS", url: "https://myfakeapi.com/api/")

    static let prodServerCollection = GoodNetworking.ApiServerCollection(
